...
/* Linux */
    ...
    #define SOCK_SEND(s,b,l,f) so_send((s), (b), (size_t)(l), (f))
    #define SOCK_RECV(s,b,l,f) so_recv((s), (b), (size_t)(l), (f))
    #define SOCK_CONNECT       so_connect
    #define SOCK_SETSOCKOPT    so_setsockopt
